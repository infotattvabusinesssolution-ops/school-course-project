...
export default function CertificatePage() {
  ...
  useEffect(() => {
    if (certificateId === 'preview') {
      setCertificate({
        _id: 'PREVIEW-1234567890',
        student: { name: 'Preview Student' },
        course: { title: 'Import & Export Masterclass' },
        issueDate: new Date(),
        examScore: 100
      });
      setLoading(false);
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col items-center py-10 px-4 font-sans selection:bg-red-100">
      ...
      <div className="w-full max-w-[1122px] shadow-2xl sm:rounded-b-2xl overflow-x-auto print:shadow-none print:rounded-none print:m-0 print:w-full print:max-w-none bg-white">
        ...
        <div ref={printRef} className="w-[1122px] h-[793px] shrink-0 bg-white relative overflow-hidden flex items-center justify-center p-12 mx-auto">
          ...
          <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" className="absolute inset-0 opacity-20 pointer-events-none z-0">
            <defs>
              <pattern id="sparkles" x="0" y="0" width="150" height="150" patternUnits="userSpaceOnUse">
                <circle cx="50" cy="50" r="1.5" fill="#0d2859" opacity="0.8"/>
                <circle cx="20" cy="80" r="2" fill="#0d2859" opacity="0.5"/>
                <circle cx="80" cy="20" r="1.2" fill="#0d2859" opacity="0.9"/>
              </pattern>
            </defs>
          ...
          <div className="absolute inset-0 flex items-center justify-center z-0 opacity-10 pointer-events-none">
            <img src="/image.png" alt="Watermark" className="w-[600px] h-[600px] object-contain" />
          </div>

          {/* Inner Geometric Border */}
          <div className="absolute inset-10 border-2 border-crmisa-navy z-10 pointer-events-none">
            <div className="absolute -top-2 -left-2 w-6 h-6 border-t-4 border-l-4 border-crmisa-navy"></div>
            <div className="absolute -top-2 -right-2 w-6 h-6 border-t-4 border-r-4 border-crmisa-navy"></div>
            <div className="absolute -bottom-2 -left-2 w-6 h-6 border-b-4 border-l-4 border-crmisa-navy"></div>
            <div className="absolute -bottom-2 -right-2 w-6 h-6 border-b-4 border-r-4 border-crmisa-navy"></div>
          </div>
          <div className="absolute inset-[44px] border-[0.5px] border-crmisa-navy z-10 pointer-events-none opacity-50"></div>
          
          {/* Company Logo - Top Right */}
          <div className="absolute top-16 right-16 z-20 print:top-16 print:right-16 h-40">
            <img src="/image.png" alt="Platform Logo" className="h-full object-contain" />
          </div>
          ...
          <div className="relative z-20 w-full h-full flex flex-col items-center py-8 justify-between">
            ...
            <div className="flex flex-col items-center text-center mt-6">
              <h1 className="text-6xl font-playfair text-crmisa-navy font-bold uppercase tracking-wide mb-1 drop-shadow-sm" style={{textShadow: "1px 1px 0px rgba(0,0,0,0.1)"}}>
                CERTIFICATE
              </h1>
            ...
            <div className="flex flex-col items-center text-center w-full max-w-4xl px-4">
              <h3 className="text-7xl font-cursive text-crmisa-navy mb-10 py-2">
                {studentName}
              </h3>
            ...
            <div className="flex items-end justify-between w-full px-16 mt-auto">
              ...
              <div className="flex flex-col items-center justify-center -mb-4 z-10 relative">
                 <div className="p-1.5 bg-white border-2 border-crmisa-navy rounded-sm shadow-sm mb-2">
              ...
              <div className="text-center w-56 pb-2 z-10 relative">
                <div className="border-b-[1.5px] border-slate-800 pb-1 mb-1 mt-12 font-playfair text-3xl font-bold uppercase tracking-wider text-crmisa-navy text-base">
                  CRMISA
                </div>
