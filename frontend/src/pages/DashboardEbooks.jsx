    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {purchasedEbooks.length === 0 ? (
        <div className="col-span-full text-center py-20 border border-slate-200 bg-white rounded-2xl shadow-sm">
          ...
          <button onClick={() => navigate("/ebooks")} className="px-6 py-2.5 bg-crmisa-navy text-white font-bold text-sm rounded-xl transition-colors hover:bg-crmisa-accentNavy">
            Browse E-Book Store
          </button>
        </div>
      ) : (
