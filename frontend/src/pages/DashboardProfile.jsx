...
export default function DashboardProfile() {
  ...
  return (
    <div className="max-w-2xl mx-auto bg-transparent p-4 sm:p-8 space-y-12">
      ...
      <div className="flex flex-col items-center text-center space-y-6">
        ...
        <div className="flex flex-col items-center gap-5">
          <div className="w-28 h-28 rounded-full bg-slate-100 border border-slate-200 overflow-hidden shrink-0">
            <img 
