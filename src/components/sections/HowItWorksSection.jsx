  ...
  return (
    <section className="py-16 lg:py-24 bg-white text-slate-800 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* 3 Step Cards Grid with Connecting Line matching Image */}
        <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          ...
          {steps.map((item, idx) => (
            <div 
              ...
              className="relative z-10 bg-white rounded-2xl border border-slate-100 shadow-xl hover:shadow-2xl transition-all duration-300 p-8 sm:p-10 flex flex-col items-center justify-between text-center group cursor-pointer hover:-translate-y-1"
            >
