...
export const TikTokIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 24 24">
    <path d="M12.525 9.007a4.67 4.67 0 001.077.126 4.673 4.673 0 004.67-4.67 4.672 4.672 0 00-.126-1.077A7.324 7.324 0 0124 9.17v3.3a10.638 10.638 0 01-6.13-1.927v6.623a6.83 6.83 0 11-6.83-6.831c.328 0 .65.024.965.072v3.424a3.398 3.398 0 102.52 3.335V0h3.333a7.319 7.319 0 00-5.333 9.007z"/>
  </svg>
);
