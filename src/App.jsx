...
export default function App() {
  ...
  // Auth state (default true for easy testing or login)
  ...
  const handleEnrollNowClick = (courseTitle, coursePrice) => {
    const title = (typeof courseTitle === 'string') ? courseTitle : "Import & Export Full Course";
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-slate-50 font-sans selection:bg-crmisa-navy selection:text-white">
      ...
      <main className="flex-1">
        ...
        {activePage === 'about' && (
          <AboutPage onOpenRegister={() => setIsRegisterOpen(true)} />
        )}
        {activePage === 'courses' && (
          <CoursesPage
            onOpenEnrol={(cTitle, cPrice) => handleEnrollNowClick(cTitle, cPrice)}
      ...
      <CartModal
        ...
        onProceedToCheckout={() => {
          const firstItem = cartItems[0] || { title: "CRMISA Ebook", price: "R499" };
      ...
      <LoginModal
        ...
        switchToRegister={() => setIsRegisterOpen(true)}
      />
      ...
      <EnrolModal
        ...
        onEnrolSuccess={() => showToast('Enrollment Confirmed! Check your email.')}
      />
