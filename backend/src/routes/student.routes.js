...
import { getStudentDashboard, getEnrolledCourses, getCoursePlayerDetails, markLessonCompleted, syncLessonProgress, getPurchasedEbooks } from "../controllers/student.controller.js";
...
router.get("/purchased-ebooks", getPurchasedEbooks);
